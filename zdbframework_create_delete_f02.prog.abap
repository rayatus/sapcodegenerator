...
*----------------------------------------------------------------------*
*&---------------------------------------------------------------------*
*&      Form  CREATE_DELETE_MULTIPLE
*&---------------------------------------------------------------------*
*       text
*----------------------------------------------------------------------*
FORM create_delete_multiple  USING   id_clsname           TYPE seoclsname
...
* Creamos el método
  ...
  <ls_method_sources>-cpdname = <ls_method>-cmpname   = 'DELETE_LIST'.
  <ls_method>-descript   = 'Delete Multiple'.
...
* Procedemos a borrar de BBDD
  mac_add_source space.
  mac_add_source '  CHECK it_list[] IS NOT INITIAL.'.
  CONCATENATE '  DELETE' id_tabname ' FROM TABLE it_list.' INTO ld_string SEPARATED BY space.
...
ENDFORM.                    " CREATE_DELETE_MULTIPLE
