...
*----------------------------------------------------------------------*
*&---------------------------------------------------------------------*
*&      Form  CREATE_SAVE_DETAIL
*&---------------------------------------------------------------------*
*       text
*----------------------------------------------------------------------*
FORM create_save_detail  USING   id_clsname           TYPE seoclsname
...
* Creamos el método
  ...
  <ls_method_sources>-cpdname = <ls_method>-cmpname   = 'SAVE_DETAILS'.
  <ls_method>-descript   = 'Save Details'.
